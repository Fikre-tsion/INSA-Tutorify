...
// In-memory cache for fast async database access without blocking the event loop
let dbCache = null;
...
// Helper function to write to database asynchronously with queue error recovery
...
app.listen(PORT, async () => {
    await readDB(); // Warm up cache on server launch
